...
| 🏠 **[nickol-knx-mcp](https://github.com/NickoScope/nickol-knx-mcp)** | Design-time **KNX / ETS6 assistant as an MCP server** — parses `.knxproj`, validates DPT / naming / status, generates Home Assistant YAML + ETS XML/CSV. No live bus access |
